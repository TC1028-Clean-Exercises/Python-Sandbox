...
List of available colors: https://cs111.wellesley.edu/labs/lab02/colors
...
def draw_color_circle(radius, segments, colors):
...
def main():
    ...
    draw_color_circle(radius, num_segments, colors)
